        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
          {features.map((feature) => (
            <Link key={feature.title} href={feature.href} className={feature.href === "#" ? "pointer-events-none" : ""}>
              <div className={`group h-full p-6 rounded-2xl border transition-all duration-300 ${feature.href !== "#" && "hover:shadow-lg hover:-translate-y-1"} bg-white dark:bg-zinc-900 ${feature.color}`}>
